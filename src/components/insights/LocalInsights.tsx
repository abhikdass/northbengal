...
const ChatBox = () => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        { user: "Bot", text: "This is a response from the bot." },
      ]);
      setIsLoading(false);
      ...
      <Card>
              ...
              >
                <div
                  className={`p-3 rounded-lg ${
                    message.user === "You" ? "bg-gray-100 text-black-800" : "bg-gray-100 text-gray-800"
                  }`}
                >
        ...
        <CardFooter className="p-4 border-t flex items-center gap-2">
          <Input
            ...
            disabled={isLoading}
          />
          <Button onClick={handleSendMessage} className="gap-1" disabled={isLoading}>
