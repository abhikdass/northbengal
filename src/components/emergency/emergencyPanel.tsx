...
import { Phone, AlertTriangle, Shield, Share2, Flame, HelpCircle, User } from "lucide-react";
...
const EmergencyPanel = ({
    ...
    const getIconForType = (type: string) => {
        switch (type) {
            case "police": return <Shield className="h-6 w-6 text-blue-500 mb-1" />;
            case "medical": return <Phone className="h-6 w-6 text-red-500 mb-1" />;
            case "fire": return <Flame className="h-6 w-6 text-orange-500 mb-1" />;
            case "tourist": return <HelpCircle className="h-6 w-6 text-green-500 mb-1" />;
            case "women": return <User className="h-6 w-6 text-purple-500 mb-1" />;
            default: return <Phone className="h-6 w-6 text-gray-500 mb-1" />;
        }
    };

    const getClassesForType = (type: string) => {
        switch (type) {
            case "police": return "bg-blue-50 hover:bg-blue-100 border-blue-200";
            case "medical": return "bg-red-50 hover:bg-red-100 border-red-200";
            case "fire": return "bg-orange-50 hover:bg-orange-100 border-orange-200";
            case "tourist": return "bg-green-50 hover:bg-green-100 border-green-200";
            case "women": return "bg-purple-50 hover:bg-purple-100 border-purple-200";
